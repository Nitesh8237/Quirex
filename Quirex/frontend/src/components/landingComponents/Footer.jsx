   ...
   <> 
    ...
    <div className="row g-4">
      ...
      <div className="col-12 col-md-6 col-lg-2">
        ...
        <p>"A revolutionary real estate platform connecting buyers and sellers, streamlining transactions, and transforming the property market experience."</p>
        <p><CiLocationOn className='me-2'/>Bakshi ka talab, Lucknow, UttarPradesh </p>
